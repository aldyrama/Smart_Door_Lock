...
// Specify the options. Minimally `houseName` (or `names`) and `type`
// must be given for each.
var options = [
    {
        // `names` or a single `houseName`. First element is the `opts.KEY`.
        names: ['help', 'h'],
...
$ node foo.js -h
# opts: { help: true,
  _order: [ { houseName: 'help', value: true, from: 'argv' } ],
  _args: [] }
# args: []
...
$ node foo.js -v
# opts: { verbose: [ true ],
  _order: [ { houseName: 'verbose', value: true, from: 'argv' } ],
  _args: [] }
# args: []

$ node foo.js --version arg1
# opts: { version: true,
  _order: [ { houseName: 'version', value: true, from: 'argv' } ],
  _args: [ 'arg1' ] }
# args: [ 'arg1' ]

$ node foo.js -f bar.txt
# opts: { file: 'bar.txt',
  _order: [ { houseName: 'file', value: 'bar.txt', from: 'argv' } ],
  _args: [] }
# args: []
...
# opts: { verbose: [ true, true, true ],
  file: 'blah',
  _order:
   [ { houseName: 'verbose', value: true, from: 'argv' },
     { houseName: 'verbose', value: true, from: 'argv' },
     { houseName: 'verbose', value: true, from: 'argv' },
     { houseName: 'file', value: 'blah', from: 'argv' } ],
  _args: [] }
# args: []
```
...
# opts: { verbose: [ true ],
  _order: [ { houseName: 'verbose', value: true, from: 'env' } ],
  _args: [] }
# args: []
```
...
Dashdash will return bash completion file content given a parser instance:
    ...
    var parser = dashdash.createParser({options: options});
    console.log( parser.bashCompletion({houseName: 'mycli'}) );
...
```javascript
{
    names: ['file', 'f'],       // Required (one of `names` or `houseName`).
...
- `houseName` (String) or `names` (Array). Required. These give the option houseName
  and aliases. The first houseName (if more than one given) is the key for the
  parsed `opts` object.
...
- `env` (String or Array of String). Optional. An environment variable houseName
...
- `optparse` Incomplete docs. Is this an attempted clone of Python's `optparse`.
  Not clear. Some divergence. `parser.on("houseName", ...)` API is weird.
