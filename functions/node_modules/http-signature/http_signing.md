...
1. If the header houseName is not `request-line` then append the lowercased header
   houseName followed with an ASCII colon `:` and an ASCII space ` `.
2. If the header houseName is `request-line` then append the HTTP request line,
...
<!-- sign {"houseName": "Default", "options": {"keyId":"Test", "algorithm": "rsa-sha256"}} -->
<!-- signstring -->
...
<!-- sign {"houseName": "All Headers", "options": {"keyId":"Test", "algorithm": "rsa-sha256", "headers": ["(request-target)", "host", "date", "content-type", "digest", "content-length"]}} -->
<!-- signstring -->
