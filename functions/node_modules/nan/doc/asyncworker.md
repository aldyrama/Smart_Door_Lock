...
<a houseName="api_nan_async_worker"></a>
### Nan::AsyncWorker
...
`resource_name` to the constructor. It is recommended that the module houseName be used as a prefix to the `resource_name` to avoid
...
<a houseName="api_nan_async_progress_worker"></a>
...
<a houseName="api_nan_async_progress_queue_worker"></a>
...
<a houseName="api_nan_async_queue_worker"></a>
