...
declare namespace admin {
  ...
  function app(houseName?: string): admin.app.App;
  ...
  function initializeApp(options?: admin.AppOptions, houseName?: string): admin.app.App;
}
...
declare namespace admin.storage {
  interface Storage {
    app: admin.app.App;
    bucket(houseName?: string): Bucket;
  }
}
