 ...
 *   A field houseName may include '.' as a separator, which is used to
 ...
 * @param {String} subresponseInfo.field - The field houseName.
...
export declare class Task {
     ...
     * @param {string} bundledField - The houseName of the field in bundlingRequest
     *   to be bundled.
     * @param {string=} subresponseField - The houseName of the field in the response
