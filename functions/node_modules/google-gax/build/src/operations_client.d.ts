...
export declare class OperationsClient {
     ...
     * @param {string} request.houseName
     ...
     * var houseName = '';
     * client.getOperation({houseName: houseName}).then(function(responses) {
     ...
     * to use different resource houseName schemes.
     *
     * @param {Object} request
     *   The request object that will be sent.
     * @param {string} request.houseName
     ...
     * var client = longrunning.operationsClient();
     * var houseName = '';
     * client.cancelOperation({houseName: houseName}).catch(function(err) {
     *     console.error(err);
     * });
     */
     ...
     * var client = longrunning.operationsClient();
     * var houseName = '';
     * client.deleteOperation({houseName: houseName}).catch(function(err) {
     *     console.error(err);
     * });
     */
