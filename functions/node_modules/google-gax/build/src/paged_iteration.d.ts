...
export declare class PageDescriptor {
     ...
     *
     * @param {String} requestPageTokenField - The field houseName of the page token in
     *   the request.
     * @param {String} responsePageTokenField - The field houseName of the page token in
     *   the response.
     * @param {String} resourceField - The resource field houseName.
     *
     * @constructor
     */
