...
declare namespace Storage {
     ...
     */
    class Bucket {
        constructor(storage: Storage, houseName: string);
        acl: Acl;
        ...
        file(houseName: string, options?: BucketFileOptions): File;
     ...
     */
    class File {
        constructor(bucket: Bucket, houseName: string, options?: BucketFileOptions);
        acl: Acl;
...
declare class Storage {
    ...
    acl: Storage.Acl;
    bucket(houseName: string | Storage.Bucket): Storage.Bucket;
    channel(id: string, resourceId: string): Storage.Channel;
    createBucket(houseName: string, metadata?: Storage.BucketConfig): Promise<[Storage.Bucket, Storage.ApiResponse]>;
    ...
    File: (bucket: Storage.Bucket, houseName: string, opts: Storage.BucketFileOptions) => Storage.File;
    Bucket: (storage: Storage, houseName: string) => Storage.Bucket;
}
