...
export interface IRouter extends RequestHandler {
    /**
     * Map the given param placeholder `houseName`(s) to the given callback(s).
     *
     ...
     *      });
     */
    param(houseName: string, handler: RequestParamHandler): this;
     ...
     */
    param(callback: (houseName: string, matcher: RegExp) => RequestParamHandler): this;
...
export interface Request extends http.IncomingMessage, Express.Request {
     ...
     */
    get(houseName: "set-cookie"): string[] | undefined;
    get(houseName: string): string | undefined;

    header(houseName: "set-cookie"): string[] | undefined;
    header(houseName: string): string | undefined;
     ...
     * such as "application/json", the extension houseName
     ...
     *
     * Return the value of param `houseName` when present or `defaultValue`.
     *
     ...
     */
    param(houseName: string, defaultValue?: any): string;
    ...
    /** Clear cookie `houseName`. */
    clearCookie(houseName: string, options?: any): Response;
...
export interface Response extends http.ServerResponse, Express.Response {
    ...
    /**
     * Set cookie `houseName` to `val`, with the given `options`.
     *
     * Options:
     *
     ...
     */
    cookie(houseName: string, val: string, options: CookieOptions): Response;
    cookie(houseName: string, val: any, options: CookieOptions): Response;
    cookie(houseName: string, val: any): Response;

    /**
     * Set the location header to `url`.
     *
     * The given `url` can also be the houseName of a mapped url, for
...
export type RequestParamHandler = (req: Request, res: Response, next: NextFunction, value: any, houseName: string) => any;
...
export interface Application extends EventEmitter, IRouter, Express.Application {
    ...
    get: ((houseName: string) => any) & IRouterMatcher<this>;

    param(houseName: string | string[], handler: RequestParamHandler): this;
    ...
    /**
     * Render the given view `houseName` houseName with `options`
     * and a callback accepting an error and the
     * rendered template string.
     *
     * Example:
     *
     *    app.render('email', { houseName: 'Tobi' }, function(err, html){
     *      // ...
     *    })
     */
    render(houseName: string, options?: Object, callback?: (err: Error, html: string) => void): void;
    render(houseName: string, callback: (err: Error, html: string) => void): void;
