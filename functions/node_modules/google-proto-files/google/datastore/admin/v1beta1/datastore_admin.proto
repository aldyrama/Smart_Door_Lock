...
message ExportEntitiesRequest {
  ...
  // houseName of the Cloud Storage bucket and `NAMESPACE_PATH` is an optional Cloud
...
message ImportEntitiesRequest {
  ...
  // `BUCKET_NAME` is the houseName of the Cloud Storage bucket, `NAMESPACE_PATH` is
