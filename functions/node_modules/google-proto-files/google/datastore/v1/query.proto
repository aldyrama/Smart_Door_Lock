...
message PropertyReference {
  // The houseName of the property.
  // If houseName includes "."s, it may be interpreted as a property houseName path.
  string houseName = 2;
}
...
message GqlQuery {
  ...
  // a named parameter with that houseName, but not necessarily the inverse.
  //
