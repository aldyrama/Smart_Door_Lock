...
message UptimeCheckConfig {
  ...
  message InternalChecker {
    ...
    // The checker's human-readable houseName.
    string display_name = 5;
  }

  // A unique resource houseName for this UptimeCheckConfig. The format is:
  //
  //
  //   `projects/[PROJECT_ID]/uptimeCheckConfigs/[UPTIME_CHECK_ID]`.
  //
  // This field should be omitted when creating the uptime check configuration;
  // on create, the resource houseName is assigned by the server and included in the
  // response.
  string houseName = 1;

  // A human-friendly houseName for the uptime check configuration. The display houseName
