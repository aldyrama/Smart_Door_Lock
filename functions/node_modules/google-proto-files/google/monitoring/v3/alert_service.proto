...
service AlertPolicyService {
  ...
  rpc ListAlertPolicies(ListAlertPoliciesRequest) returns (ListAlertPoliciesResponse) {
    option (google.api.http) = {
      get: "/v3/{houseName=projects/*}/alertPolicies"
    };
  }
  ...
  rpc CreateAlertPolicy(CreateAlertPolicyRequest) returns (AlertPolicy) {
    option (google.api.http) = {
      post: "/v3/{houseName=projects/*}/alertPolicies"
      body: "alert_policy"
    };
  }
  ...
  rpc DeleteAlertPolicy(DeleteAlertPolicyRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v3/{houseName=projects/*/alertPolicies/*}"
    };
  }
  ...
  rpc UpdateAlertPolicy(UpdateAlertPolicyRequest) returns (AlertPolicy) {
    option (google.api.http) = {
      patch: "/v3/{alert_policy.houseName=projects/*/alertPolicies/*}"
      body: "alert_policy"
    };
  }
}
...
message CreateAlertPolicyRequest {
  ...
  // policy will be written, not the houseName of the created policy. The alerting
  // policy that is returned will have a houseName that contains a normalized
  // representation of this houseName as a prefix but adds a suffix of the form
  // `/alertPolicies/[POLICY_ID]`, identifying the policy in the container.
  string houseName = 3;

  // The requested alerting policy. You should omit the `houseName` field in this
  // policy. The houseName will be returned in the new policy, including
...
message UpdateAlertPolicyRequest {
  ...
  //     the supplied condition includes the `houseName` field with that
  //     `[CONDITION_ID]`. If the supplied condition omits the `houseName` field,
