...
service ByteStream {
  ...
  //
  // Calling `Write()` on a resource houseName that was previously written and
  ...
  // resource houseName, the sequence of returned `committed_size` values will be
  // non-decreasing.
...
message ReadRequest {
  // The houseName of the resource to read.
...
message WriteRequest {
  // The houseName of the resource to write. This **must** be set on the first
...
message QueryWriteStatusRequest {
  // The houseName of the resource whose write status is being requested.
  string resource_name = 1;
}
