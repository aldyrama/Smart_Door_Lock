...
message Document {
  // The resource houseName of the document, for example
  ...
  //
  // A simple field houseName contains only characters `a` to `z`, `A` to `Z`,
  ...
  //
  // Within a field path, a quoted field houseName starts and ends with `` ` `` and
