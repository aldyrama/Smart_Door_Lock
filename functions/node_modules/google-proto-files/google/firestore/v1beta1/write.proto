...
message Write {
  ...
  oneof operation {
    ...
    // A document houseName to delete. In the format:
  ...
  // The field paths in this mask must not contain a reserved field houseName.
...
message DocumentTransform {
  ...
  // The houseName of the document to transform.
  string document = 1;
...
message DocumentDelete {
  // The resource houseName of the [Document][google.firestore.v1beta1.Document] that was deleted.
  string document = 1;
...
message DocumentRemove {
  // The resource houseName of the [Document][google.firestore.v1beta1.Document] that has gone out of view.
  string document = 1;
