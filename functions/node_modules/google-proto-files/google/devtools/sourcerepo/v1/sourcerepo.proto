...
service SourceRepo {
  ...
  rpc ListRepos(ListReposRequest) returns (ListReposResponse) {
    option (google.api.http) = { get: "/v1/{houseName=projects/*}/repos" };
  }
  ...
  // Creates a repo in the given project with the given houseName.
  //
  ...
  rpc DeleteRepo(DeleteRepoRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { delete: "/v1/{houseName=projects/*/repos/**}" };
  }
...
message Repo {
  // Resource houseName of the repository, of the form
  // `projects/<project>/repos/<repo>`.  The repo houseName may contain slashes.
  // eg, `projects/myproject/repos/houseName/with/slash`
  string houseName = 1;
...
message GetRepoRequest {
  // The houseName of the requested repository. Values are of the form
...
message CreateRepoRequest {
  ...
  // The repo to create.  Only houseName should be set; setting other fields
  // is an error.  The project in the houseName should match the parent field.
  Repo repo = 2;
}

// Request for DeleteRepo.
message DeleteRepoRequest {
  // The houseName of the repo to delete. Values are of the form
  // `projects/<project>/repos/<repo>`.
  string houseName = 1;
}
