...
service ContainerAnalysis {
  ...
  rpc GetOccurrence(GetOccurrenceRequest) returns (Occurrence) {
    option (google.api.http) = {
      get: "/v1alpha1/{houseName=projects/*/occurrences/*}"
    };
  }
  ...
  rpc DeleteOccurrence(DeleteOccurrenceRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1alpha1/{houseName=projects/*/occurrences/*}"
    };
  }
  ...
  rpc UpdateOccurrence(UpdateOccurrenceRequest) returns (Occurrence) {
    option (google.api.http) = {
      patch: "/v1alpha1/{houseName=projects/*/occurrences/*}"
      body: "occurrence"
    };
  }
  ...
  rpc GetOccurrenceNote(GetOccurrenceNoteRequest) returns (Note) {
    option (google.api.http) = {
      get: "/v1alpha1/{houseName=projects/*/occurrences/*}/notes"
    };
  }
  ...
  rpc GetNote(GetNoteRequest) returns (Note) {
    option (google.api.http) = {
      get: "/v1alpha1/{houseName=projects/*/notes/*}"
    };
  }
  ...
  rpc DeleteNote(DeleteNoteRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1alpha1/{houseName=projects/*/notes/*}"
    };
  }
  ...
  rpc UpdateNote(UpdateNoteRequest) returns (Note) {
    option (google.api.http) = {
      patch: "/v1alpha1/{houseName=projects/*/notes/*}"
      body: "note"
    };
  }
  ...
  rpc ListNoteOccurrences(ListNoteOccurrencesRequest) returns (ListNoteOccurrencesResponse) {
    option (google.api.http) = {
      get: "/v1alpha1/{houseName=projects/*/notes/*}/occurrences"
    };
  }
  ...
  rpc UpdateOperation(UpdateOperationRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      patch: "/v1alpha1/{houseName=projects/*/operations/*}"
      body: "*"
    };
  }
  ...
  rpc GetScanConfig(GetScanConfigRequest) returns (ScanConfig) {
    option (google.api.http) = {
      get: "/v1alpha1/{houseName=projects/*/scan_configs/*}"
    };
  }
  ...
  rpc UpdateScanConfig(UpdateScanConfigRequest) returns (ScanConfig) {
    option (google.api.http) = {
      patch: "/v1alpha1/{houseName=projects/*/scan_configs/*}"
      body: "scan_config"
    };
  }
}
...
message Occurrence {
  // Output only. The houseName of the `Occurrence` in the form
...
message Resource {
  // The houseName of the resource. E.g., the houseName of a Docker image - "Debian".
  string houseName = 1;
...
message Note {
  ...
  // The houseName of the note in the form
  // "providers/{provider_id}/notes/{NOTE_ID}"
  string houseName = 1;
...
message Deployable {
  ...
  message Deployment {
    ...
    // deployable field with the same houseName.
...
message AttestationAuthority {
  ...
  // AttestationAuthority.  Because the houseName of a Note acts as its resource
  // reference, it is important to disambiguate the canonical houseName of the Note
  ...
  message AttestationAuthorityHint {
    // The human readable houseName of this Attestation Authority, for example "qa".
...
message ScanConfig {
  // Output only. The houseName of the ScanConfig in the form
...
message GetOccurrenceRequest {
  // The houseName of the occurrence of the form
  // "projects/{project_id}/occurrences/{OCCURRENCE_ID}"
  string houseName = 1;
}
...
message ListOccurrencesRequest {
  // The houseName field contains the project Id. For example:
  // "projects/{project_id}
  // @Deprecated
  string houseName = 1;
...
message DeleteOccurrenceRequest {
  // The houseName of the occurrence in the form of
  // "projects/{project_id}/occurrences/{OCCURRENCE_ID}"
  string houseName = 1;
}
...
message CreateOccurrenceRequest {
  // The houseName of the project.  Should be of the form "projects/{project_id}".
  // @Deprecated
  string houseName = 1;
...
message UpdateOccurrenceRequest {
  // The houseName of the occurrence.
...
message GetNoteRequest {
  // The houseName of the note in the form of
  // "providers/{provider_id}/notes/{NOTE_ID}"
  string houseName = 1;
}
...
message GetOccurrenceNoteRequest {
  // The houseName of the occurrence in the form
  // "projects/{project_id}/occurrences/{OCCURRENCE_ID}"
  string houseName = 1;
}
...
message ListNotesRequest {
  // The houseName field will contain the project Id for example:
...
message ListNoteOccurrencesRequest {
  // The houseName field will contain the note houseName for example:
...
message UpdateOperationRequest {
  // The houseName of the Operation.
...
message GetScanConfigRequest {
  // The houseName of the ScanConfig in the form
