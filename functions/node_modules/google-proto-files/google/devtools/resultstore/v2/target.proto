...
message Target {
  ...
  // Arbitrary houseName-value pairs.
...
// These correspond to the suffix of the rule houseName. Eg cc_test has type TEST.
enum TargetType {
