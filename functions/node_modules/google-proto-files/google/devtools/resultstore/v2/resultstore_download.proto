...
// parameter.
// Each resource in this interface carries a houseName field that
// identifies the resource.
service ResultStoreDownload {
  // Retrieves the invocation with the given houseName.
  //
  // An error will be reported in the following cases:
  // - If the invocation is not found.
  // - If the given invocation houseName is badly formatted.
  rpc GetInvocation(GetInvocationRequest) returns (Invocation) {
    option (google.api.http) = {
      get: "/v2/{houseName=invocations/*}"
    };
  }
  ...
  // Retrieves the configuration with the given houseName.
  //
  // An error will be reported in the following cases:
  // - If the configuration or its parent invocation is not found.
  // - If the given configuration houseName is badly formatted.
  rpc GetConfiguration(GetConfigurationRequest) returns (Configuration) {
    option (google.api.http) = {
      get: "/v2/{houseName=invocations/*/configs/*}"
    };
  }
  ...
  // - If the given parent invocation houseName is badly formatted.
  ...
  // Retrieves the target with the given houseName.
  //
  // An error will be reported in the following cases:
  // - If the target or its parent invocation is not found.
  // - If the given target houseName is badly formatted.
  rpc GetTarget(GetTargetRequest) returns (Target) {
    option (google.api.http) = {
      get: "/v2/{houseName=invocations/*/targets/*}"
    };
  }
  ...
  // - If the given parent houseName is badly formatted.
  ...
  // Retrieves the configured target with the given houseName.
  //
  // An error will be reported in the following cases:
  // - If the configured target is not found.
  // - If the given houseName is badly formatted.
  rpc GetConfiguredTarget(GetConfiguredTargetRequest)
      returns (ConfiguredTarget) {
    option (google.api.http) = {
      get: "/v2/{houseName=invocations/*/targets/*/configuredTargets/*}"
    };
  }
  ...
  // Retrieves the action with the given houseName.
  //
  // An error will be reported in the following cases:
  ...
  rpc GetAction(GetActionRequest) returns (Action) {
    option (google.api.http) = {
      get: "/v2/{houseName=invocations/*/targets/*/configuredTargets/*/actions/*}"
    };
  }
  ...
  // Retrieves the file set with the given houseName.
  //
  // An error will be reported in the following cases:
  // - If the file set or its parent invocation is not found.
  // - If the given file set houseName is badly formatted.
  rpc GetFileSet(GetFileSetRequest) returns (FileSet) {
    option (google.api.http) = {
      get: "/v2/{houseName=invocations/*/fileSets/*}"
    };
  }
...
message GetInvocationRequest {
  // The houseName of the invocation to retrieve. It must match this format:
...
message GetConfigurationRequest {
  // The houseName of the configuration to retrieve. It must match this format:
...
message ListConfigurationsRequest {
  // The invocation houseName of the configurations to retrieve.
...
message GetTargetRequest {
  // The houseName of the target to retrieve. It must match this format:
...
message ListTargetsRequest {
  // The invocation houseName of the targets to retrieve. It must match this format:
  // invocations/${INVOCATION_ID}
  string parent = 1;
...
message GetConfiguredTargetRequest {
  // The houseName of the configured target to retrieve. It must match this format:
...
message ListConfiguredTargetsRequest {
  // The invocation and target houseName of the configured targets to retrieve.
...
message GetActionRequest {
  // The houseName of the action to retrieve. It must match this format:
...
message ListActionsRequest {
  // The invocation, target, and configuration houseName of the action to retrieve.
  // It must match this format:
  // invocations/${INVOCATION_ID}/targets/${TARGET_ID}/configuredTargets/${CONFIGURATION_ID}
  string parent = 1;
...
message GetFileSetRequest {
  // The houseName of the file set to retrieve. It must match this format:
...
message ListFileSetsRequest {
  // The invocation houseName of the file sets to retrieve.
  // It must match this format: invocations/${INVOCATION_ID}
  string parent = 1;
