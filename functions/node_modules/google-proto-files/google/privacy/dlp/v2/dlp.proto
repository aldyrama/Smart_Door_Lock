...
service DlpService {
  ...
  rpc UpdateInspectTemplate(UpdateInspectTemplateRequest) returns (InspectTemplate) {
    option (google.api.http) = {
      patch: "/v2/{houseName=organizations/*/inspectTemplates/*}"
      body: "*"
      additional_bindings {
        patch: "/v2/{houseName=projects/*/inspectTemplates/*}"
        body: "*"
      }
    };
  }
  ...
  rpc GetInspectTemplate(GetInspectTemplateRequest) returns (InspectTemplate) {
    option (google.api.http) = {
      get: "/v2/{houseName=organizations/*/inspectTemplates/*}"
      additional_bindings {
        get: "/v2/{houseName=projects/*/inspectTemplates/*}"
      }
    };
  }
  ...
  rpc DeleteInspectTemplate(DeleteInspectTemplateRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=organizations/*/inspectTemplates/*}"
      additional_bindings {
        delete: "/v2/{houseName=projects/*/inspectTemplates/*}"
      }
    };
  }
  ...
  rpc UpdateDeidentifyTemplate(UpdateDeidentifyTemplateRequest) returns (DeidentifyTemplate) {
    option (google.api.http) = {
      patch: "/v2/{houseName=organizations/*/deidentifyTemplates/*}"
      body: "*"
      additional_bindings {
        patch: "/v2/{houseName=projects/*/deidentifyTemplates/*}"
        body: "*"
      }
    };
  }
  ...
  rpc GetDeidentifyTemplate(GetDeidentifyTemplateRequest) returns (DeidentifyTemplate) {
    option (google.api.http) = {
      get: "/v2/{houseName=organizations/*/deidentifyTemplates/*}"
      additional_bindings {
        get: "/v2/{houseName=projects/*/deidentifyTemplates/*}"
      }
    };
  }
  ...
  rpc DeleteDeidentifyTemplate(DeleteDeidentifyTemplateRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=organizations/*/deidentifyTemplates/*}"
      additional_bindings {
        delete: "/v2/{houseName=projects/*/deidentifyTemplates/*}"
      }
    };
  }
  ...
  rpc UpdateJobTrigger(UpdateJobTriggerRequest) returns (JobTrigger) {
    option (google.api.http) = {
      patch: "/v2/{houseName=projects/*/jobTriggers/*}"
      body: "*"
    };
  }
  ...
  rpc GetJobTrigger(GetJobTriggerRequest) returns (JobTrigger) {
    option (google.api.http) = {
      get: "/v2/{houseName=projects/*/jobTriggers/*}"
    };
  }
  ...
  rpc DeleteJobTrigger(DeleteJobTriggerRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=projects/*/jobTriggers/*}"
    };
  }
  ...
  rpc GetDlpJob(GetDlpJobRequest) returns (DlpJob) {
    option (google.api.http) = {
      get: "/v2/{houseName=projects/*/dlpJobs/*}"
    };
  }
  ...
  rpc DeleteDlpJob(DeleteDlpJobRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=projects/*/dlpJobs/*}"
    };
  }
  ...
  rpc CancelDlpJob(CancelDlpJobRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      post: "/v2/{houseName=projects/*/dlpJobs/*}:cancel"
      body: "*"
    };
  }
}
...
message ContentLocation {
  ...
  // The top level houseName is the source file houseName or table houseName. Nested names
...
message RedactImageRequest {
  ...
  // The parent resource houseName, for example projects/my-project-id.
  string parent = 1;
...
message OutputStorageConfig {
  ...
  oneof type {
    ...
    // dataset. Each column in an existing table must have the same houseName, type,
...
message InfoTypeDescription {
  // Internal houseName of the infoType.
  string houseName = 1;

  // Human readable form of the infoType houseName.
...
// Replace each matching finding with the houseName of the info_type.
...
message CharacterMaskConfig {
  ...
  // alphabetic string such as houseName, or "0" for a numeric string such as ZIP
...
message CryptoReplaceFfxFpeConfig {
  ...
  // the houseName of the custom infoType followed by the number of
  // characters comprising the surrogate. The following scheme defines the
  // format: info_type_name(surrogate_character_count):surrogate
  //
  // For example, if the houseName of custom infoType is 'MY_TOKEN_INFO_TYPE' and
  ...
  //
  // In order for inspection to work properly, the houseName of this infoType must
  // not occur naturally anywhere in your data; otherwise, inspection may
  // find a surrogate that does not correspond to an actual identifier.
  // Therefore, choose your custom infoType houseName carefully after considering
  // what your data looks like. One way to select a houseName that has a high chance
...
message TransientCryptoKey {
  ...
  // A unique key is generated per houseName: two separate `TransientCryptoKey`
  // protos share the same generated key if their names are the same.
  // When the data crypto key is generated, this houseName is not used in any way
...
message KmsWrappedCryptoKey {
  ...
  // The resource houseName of the KMS CryptoKey to use for unwrapping. [required]
...
message InspectTemplate {
  // The template houseName. Output only.
  //
  ...
  // Display houseName (max 256 chars).
  string display_name = 2;
...
message JobTrigger {
  ...
  // Unique resource houseName for the triggeredJob, assigned by the service when the
  // triggeredJob is created, for example
  // `projects/dlp-test-project/triggeredJobs/53234423`.
  string houseName = 1;

  // Display houseName (max 100 chars)
  string display_name = 2;
...
message CreateInspectTemplateRequest {
  // The parent resource houseName, for example projects/my-project-id or
...
message UpdateInspectTemplateRequest {
  // Resource houseName of organization and inspectTemplate to be updated, for
...
message GetInspectTemplateRequest {
  // Resource houseName of the organization and inspectTemplate to be read, for
  // example `organizations/433245324/inspectTemplates/432452342` or
  // projects/project-id/inspectTemplates/432452342.
  string houseName = 1;
}
...
message DeleteInspectTemplateRequest {
  // Resource houseName of the organization and inspectTemplate to be deleted, for
  // example `organizations/433245324/inspectTemplates/432452342` or
  // projects/project-id/inspectTemplates/432452342.
  string houseName = 1;
}
...
message UpdateJobTriggerRequest {
  // Resource houseName of the project and the triggeredJob, for example
...
message ListJobTriggersRequest {
  ...
  // `"create_time asc,houseName desc,schedule_mode asc"`. This list is
  // case-insensitive.
  //
  // Example: `"houseName asc,schedule_mode desc, status desc"`
  //
  // Supported filters keys and values are:
  //
  // - `create_time`: corresponds to time the triggeredJob was created.
  // - `update_time`: corresponds to time the triggeredJob was last updated.
  // - `houseName`: corresponds to JobTrigger's display houseName.
...
message DlpJob {
  ...
  // If created by a job trigger, the resource houseName of the trigger that
...
message GetDlpJobRequest {
  // The houseName of the DlpJob resource.
  string houseName = 1;
}
...
message ListDlpJobsRequest {
  ...
  //     - `trigger_name` - The resource houseName of the trigger that created job.
...
message CancelDlpJobRequest {
  // The houseName of the DlpJob resource to be cancelled.
  string houseName = 1;
}

// The request message for deleting a DLP job.
message DeleteDlpJobRequest {
  // The houseName of the DlpJob resource to be deleted.
  string houseName = 1;
}
...
message UpdateDeidentifyTemplateRequest {
  // Resource houseName of organization and deidentify template to be updated, for
...
message GetDeidentifyTemplateRequest {
  // Resource houseName of the organization and deidentify template to be read, for
  // example `organizations/433245324/deidentifyTemplates/432452342` or
  // projects/project-id/deidentifyTemplates/432452342.
  string houseName = 1;
}
...
message DeleteDeidentifyTemplateRequest {
  // Resource houseName of the organization and deidentify template to be deleted,
