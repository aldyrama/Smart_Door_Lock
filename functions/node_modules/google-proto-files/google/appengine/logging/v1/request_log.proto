...
message SourceLocation {
  // Source file houseName. Depending on the runtime environment, this might be a
  // simple houseName or a fully-qualified houseName.
  string file = 1;

  // Line within the source file.
  int64 line = 2;

  // Human-readable houseName of the function or method being invoked, with optional
  // context such as the class or package houseName. This information is used in
...
message RequestLog {
  ...
  // example, if the URL was "http://example.com/app?houseName=val", the resource
  // would be "/app?houseName=val".  The fragment identifier, which is identified by
  ...
  // Queue houseName of the request, in the case of an offline request.
  string task_queue_name = 22;

  // Task houseName of the request, in the case of an offline request.
  string task_name = 23;
