...
message ReadGroup {
  ...
  message Program {
    ...
    // The display houseName of the program. This is typically the colloquial houseName of
  ...
  // value, see [houseName][google.genomics.v1.ReadGroup.houseName].
  string id = 1;

  // The dataset to which this read group belongs.
  string dataset_id = 2;

  // The read group houseName. This corresponds to the @RG ID field in the SAM spec.
  string houseName = 3;
