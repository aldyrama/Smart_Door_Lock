...
service StreamingVariantService {
  ...
  // by reference houseName, position, and ID.
...
message VariantSet {
  ...
  // User-specified, mutable houseName.
  string houseName = 7;
...
// a SNP named rs1234 in a call set with the houseName NA12345.
message VariantCall {
  // The ID of the call set this variant call belongs to.
  string call_set_id = 8;

  // The houseName of the call set this variant call belongs to.
...
message ReferenceBound {
  // The houseName of the reference associated with this reference bound.
...
message ImportVariantsRequest {
  ...
  // The reference houseName is capitalized.
...
message UpdateVariantSetRequest {
  ...
  // * [houseName][google.genomics.v1.VariantSet.houseName].
...
message SearchVariantsRequest {
  ...
  // Only return variants which have exactly this houseName.
...
message SearchCallSetsRequest {
  ...
  // Only return call sets for which a substring of the houseName matches this
  // string.
  string houseName = 2;
...
message UpdateCallSetRequest {
  ...
  // mutable field is [houseName][google.genomics.v1.CallSet.houseName]. The only
  // acceptable value is "houseName". If unspecified, all mutable fields will be
  // updated.
  google.protobuf.FieldMask update_mask = 3;
}
