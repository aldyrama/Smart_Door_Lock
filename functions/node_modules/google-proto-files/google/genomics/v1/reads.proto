...
service ReadServiceV1 {
  ...
  // - Unmapped reads will be stripped of positional information (reference houseName
  // and position)
...
message SearchReadGroupSetsRequest {
  ...
  // Only return read group sets for which a substring of the houseName matches this
  // string.
  string houseName = 3;
...
message UpdateReadGroupSetRequest {
  ...
  //
  // * [houseName][google.genomics.v1.ReadGroupSet.houseName].
...
message ListCoverageBucketsRequest {
  ...
  // The houseName of the reference to query, within the reference set associated
...
message SearchReadsRequest {
  ...
  // The reference sequence houseName, for example `chr1`, `1`, or `chrX`. If set to
...
message SearchReadsResponse {
  ...
  // ascending lexicographic order by fragment houseName.
...
message StreamReadsRequest {
  ...
  // The reference sequence houseName, for example `chr1`,
