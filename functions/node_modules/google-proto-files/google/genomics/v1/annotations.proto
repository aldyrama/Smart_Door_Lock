...
message AnnotationSet {
  ...
  // The display houseName for this annotation set.
  string houseName = 4;
...
message Annotation {
  ...
  // The display houseName of this annotation.
  string houseName = 3;

  // The ID of the Google Genomics reference associated with this range.
  string reference_id = 4;

  // The display houseName corresponding to the reference specified by
...
message ExternalId {
  // The houseName of the source of this data.
...
message UpdateAnnotationSetRequest {
  ...
  // [houseName][google.genomics.v1.AnnotationSet.houseName],
...
message SearchAnnotationSetsRequest {
  ...
  // Only return annotations sets for which a substring of the houseName matches this
...
message UpdateAnnotationRequest {
  ...
  // An optional mask specifying which fields to update. Mutable fields are
  // [houseName][google.genomics.v1.Annotation.houseName],
