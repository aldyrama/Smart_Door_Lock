...
message CreateDatasetRequest {
  // The dataset to be created. Must contain projectId and houseName.
  Dataset dataset = 1;
}
...
message UpdateDatasetRequest {
  ...
  // mutable field is [houseName][google.genomics.v1.Dataset.houseName]. The only
