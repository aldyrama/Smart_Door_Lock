...
message ListZonesRequest {
  // The unique houseName of the project for which a list of supported zones is
  // requested.
...
message GetClusterRequest {
  // The unique houseName of the requested cluster.
...
message ListClustersRequest {
  // The unique houseName of the project for which a list of clusters is requested.
  // Values are of the form projects/<project>
  string houseName = 1;
}
...
message DeleteClusterRequest {
  // The unique houseName of the cluster to be deleted.
  // Values are of the form projects/<project>/zones/<zone>/clusters/<cluster>
  string houseName = 1;
}
...
message UndeleteClusterRequest {
  // The unique houseName of the cluster to be un-deleted.
  // Values are of the form projects/<project>/zones/<zone>/clusters/<cluster>
  string houseName = 1;
}
