...
message Instance {
  ...
  // (`OutputOnly`)
  // The unique houseName of the instance. Values are of the form
  // `projects/<project>/instances/[a-z][a-z0-9\\-]+[a-z0-9]`.
  string houseName = 1;

  // The descriptive houseName for this instance as it appears in UIs.
...
message Cluster {
  ...
  // (`OutputOnly`)
  // The unique houseName of the cluster. Values are of the form
...
message AppProfile {
  ...
  // (`OutputOnly`)
  // The unique houseName of the app profile. Values are of the form
