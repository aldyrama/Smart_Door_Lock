...
message Table {
  ...
  enum View {
    ...
    // Only populates `houseName`.
    NAME_ONLY = 1;

    // Only populates `houseName` and fields related to the table's schema.
    SCHEMA_VIEW = 2;

    // Only populates `houseName` and fields related to the table's
    // replication state.
    REPLICATION_VIEW = 3;
  ...
  // (`OutputOnly`)
  // The unique houseName of the table. Values are of the form
...
message Snapshot {
  ...
  // (`OutputOnly`)
  // The unique houseName of the snapshot.
