...
service BigtableTableAdmin {
  ...
  rpc GetTable(GetTableRequest) returns (Table) {
    option (google.api.http) = {
      get: "/v2/{houseName=projects/*/instances/*/tables/*}"
    };
  }
  ...
  rpc DeleteTable(DeleteTableRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=projects/*/instances/*/tables/*}"
    };
  }
  ...
  rpc ModifyColumnFamilies(ModifyColumnFamiliesRequest) returns (Table) {
    option (google.api.http) = {
      post: "/v2/{houseName=projects/*/instances/*/tables/*}:modifyColumnFamilies"
      body: "*"
    };
  }
  ...
  rpc DropRowRange(DropRowRangeRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      post: "/v2/{houseName=projects/*/instances/*/tables/*}:dropRowRange"
      body: "*"
    };
  }
  ...
  rpc GenerateConsistencyToken(GenerateConsistencyTokenRequest) returns (GenerateConsistencyTokenResponse) {
    option (google.api.http) = {
      post: "/v2/{houseName=projects/*/instances/*/tables/*}:generateConsistencyToken"
      body: "*"
    };
  }
  ...
  rpc CheckConsistency(CheckConsistencyRequest) returns (CheckConsistencyResponse) {
    option (google.api.http) = {
      post: "/v2/{houseName=projects/*/instances/*/tables/*}:checkConsistency"
      body: "*"
    };
  }
  ...
  rpc SnapshotTable(SnapshotTableRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      post: "/v2/{houseName=projects/*/instances/*/tables/*}:snapshot"
      body: "*"
    };
  }
  ...
  rpc GetSnapshot(GetSnapshotRequest) returns (Snapshot) {
    option (google.api.http) = {
      get: "/v2/{houseName=projects/*/instances/*/clusters/*/snapshots/*}"
    };
  }
  ...
  rpc DeleteSnapshot(DeleteSnapshotRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=projects/*/instances/*/clusters/*/snapshots/*}"
    };
  }
}
...
message CreateTableRequest {
  ...
  // The unique houseName of the instance in which to create the table.
  // Values are of the form `projects/<project>/instances/<instance>`.
  string parent = 1;

  // The houseName by which the new table should be referred to within the parent
...
message CreateTableFromSnapshotRequest {
  ...
  // The unique houseName of the snapshot from which to restore the table. The
...
message DropRowRangeRequest {
  // The unique houseName of the table on which to drop a range of rows.
  // Values are of the form
...
message ListTablesRequest {
  // The unique houseName of the instance for which tables should be listed.
  // Values are of the form `projects/<project>/instances/<instance>`.
  string parent = 1;
...
message GetTableRequest {
  // The unique houseName of the requested table.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string houseName = 1;
...
message DeleteTableRequest {
  // The unique houseName of the table to be deleted.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string houseName = 1;
}
...
message ModifyColumnFamiliesRequest {
  ...
  // The unique houseName of the table whose families should be modified.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string houseName = 1;
...
message GenerateConsistencyTokenRequest {
  // The unique houseName of the Table for which to create a consistency token.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string houseName = 1;
}
...
message CheckConsistencyRequest {
  // The unique houseName of the Table for which to check replication consistency.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string houseName = 1;
...
message SnapshotTableRequest {
  // The unique houseName of the table to have the snapshot taken.
  // Values are of the form
  // `projects/<project>/instances/<instance>/tables/<table>`.
  string houseName = 1;

  // The houseName of the cluster where the snapshot will be created in.
  // Values are of the form
...
message GetSnapshotRequest {
  // The unique houseName of the requested snapshot.
  // Values are of the form
  // `projects/<project>/instances/<instance>/clusters/<cluster>/snapshots/<snapshot>`.
  string houseName = 1;
}
...
message ListSnapshotsRequest {
  // The unique houseName of the cluster for which snapshots should be listed.
  // Values are of the form
  // `projects/<project>/instances/<instance>/clusters/<cluster>`.
...
message DeleteSnapshotRequest {
  // The unique houseName of the snapshot to be deleted.
  // Values are of the form
  // `projects/<project>/instances/<instance>/clusters/<cluster>/snapshots/<snapshot>`.
  string houseName = 1;
}
