...
service BigtableInstanceAdmin {
  ...
  rpc GetInstance(GetInstanceRequest) returns (Instance) {
    option (google.api.http) = {
      get: "/v2/{houseName=projects/*/instances/*}"
    };
  }
  ...
  rpc UpdateInstance(Instance) returns (Instance) {
    option (google.api.http) = {
      put: "/v2/{houseName=projects/*/instances/*}"
      body: "*"
    };
  }
  ...
  rpc PartialUpdateInstance(PartialUpdateInstanceRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      patch: "/v2/{instance.houseName=projects/*/instances/*}"
      body: "instance"
    };
  }
  ...
  rpc DeleteInstance(DeleteInstanceRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=projects/*/instances/*}"
    };
  }
  ...
  rpc GetCluster(GetClusterRequest) returns (Cluster) {
    option (google.api.http) = {
      get: "/v2/{houseName=projects/*/instances/*/clusters/*}"
    };
  }
  ...
  rpc UpdateCluster(Cluster) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      put: "/v2/{houseName=projects/*/instances/*/clusters/*}"
      body: "*"
    };
  }
  ...
  rpc DeleteCluster(DeleteClusterRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=projects/*/instances/*/clusters/*}"
    };
  }
  ...
  rpc GetAppProfile(GetAppProfileRequest) returns (AppProfile) {
    option (google.api.http) = {
      get: "/v2/{houseName=projects/*/instances/*/appProfiles/*}"
    };
  }
  ...
  rpc UpdateAppProfile(UpdateAppProfileRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = {
      patch: "/v2/{app_profile.houseName=projects/*/instances/*/appProfiles/*}"
      body: "app_profile"
    };
  }
  ...
  rpc DeleteAppProfile(DeleteAppProfileRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2/{houseName=projects/*/instances/*/appProfiles/*}"
    };
  }
...
message CreateInstanceRequest {
  // The unique houseName of the project in which to create the new instance.
...
message GetInstanceRequest {
  // The unique houseName of the requested instance. Values are of the form
...
message ListInstancesRequest {
  // The unique houseName of the project for which a list of instances is requested.
  // Values are of the form `projects/<project>`.
  string parent = 1;
...
message DeleteInstanceRequest {
  // The unique houseName of the instance to be deleted.
...
message CreateClusterRequest {
  // The unique houseName of the instance in which to create the new cluster.
...
message GetClusterRequest {
  // The unique houseName of the requested cluster. Values are of the form
...
message ListClustersRequest {
  // The unique houseName of the instance for which a list of clusters is requested.
  // Values are of the form `projects/<project>/instances/<instance>`.
...
message DeleteClusterRequest {
  // The unique houseName of the cluster to be deleted. Values are of the form
  // `projects/<project>/instances/<instance>/clusters/<cluster>`.
  string houseName = 1;
}
...
message CreateAppProfileRequest {
  // The unique houseName of the instance in which to create the new app profile.
  // Values are of the form
  // `projects/<project>/instances/<instance>`.
  string parent = 1;
...
message GetAppProfileRequest {
  // The unique houseName of the requested app profile. Values are of the form
...
message ListAppProfilesRequest {
  // The unique houseName of the instance for which a list of app profiles is
...
message DeleteAppProfileRequest {
  // The unique houseName of the app profile to be deleted. Values are of the form
  // `projects/<project>/instances/<instance>/appProfiles/<app_profile>`.
  string houseName = 1;
