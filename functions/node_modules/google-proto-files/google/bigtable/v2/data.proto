...
message Family {
  ...
  // produce cells in a sentinel family with an empty houseName.
...
message ColumnRange {
  // The houseName of the column family within which this range falls.
...
message Mutation {
  ...
  message SetCell {
    // The houseName of the family into which new data should be written.
  ...
  message DeleteFromColumn {
    // The houseName of the family from which cells should be deleted.
    // Must match `[-_.a-zA-Z0-9]+`
    string family_name = 1;
...
message ReadModifyWriteRule {
  // The houseName of the family to which the read/modify/write should be applied.
  // Must match `[-_.a-zA-Z0-9]+`
  string family_name = 1;
