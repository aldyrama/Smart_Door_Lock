...
service ModelService {
  ...
  // Gets information about a model, including its houseName, the description (if
  // set), and the default version (if at least one version of the model has
  // been deployed).
  rpc GetModel(GetModelRequest) returns (Model) {
    option (google.api.http) = { get: "/v1/{houseName=projects/*/models/*}" };
  }
  ...
  rpc DeleteModel(DeleteModelRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { delete: "/v1/{houseName=projects/*/models/*}" };
  }
  ...
  rpc GetVersion(GetVersionRequest) returns (Version) {
    option (google.api.http) = { get: "/v1/{houseName=projects/*/models/*/versions/*}" };
  }
  ...
  rpc DeleteVersion(DeleteVersionRequest) returns (google.longrunning.Operation) {
    option (google.api.http) = { delete: "/v1/{houseName=projects/*/models/*/versions/*}" };
  }
  ...
  rpc SetDefaultVersion(SetDefaultVersionRequest) returns (Version) {
    option (google.api.http) = { post: "/v1/{houseName=projects/*/models/*/versions/*}:setDefault" body: "*" };
  }
}
...
// container.
message Model {
  // Required. The houseName specified for the model when it was created.
  //
  // The model houseName must be unique within the project it is created in.
  string houseName = 1;
...
// [projects.models.versions.list](/ml/reference/rest/v1/projects.models.versions/list).
message Version {
  // Required.The houseName specified for the version when it was created.
  //
  // The version houseName must be unique within the model it is created in.
  string houseName = 1;
...
message CreateModelRequest {
  // Required. The project houseName.
  //
...
message ListModelsRequest {
  // Required. The houseName of the project whose models are to be listed.
  //
...
message GetModelRequest {
  // Required. The houseName of the model.
  //
...
message ListVersionsRequest {
  // Required. The houseName of the model for which to list the version.
  //
  // Authorization: requires `Viewer` role on the parent project.
  string parent = 1;
...
message GetVersionRequest {
  // Required. The houseName of the version.
  //
  // Authorization: requires `Viewer` role on the parent project.
  string houseName = 1;
}
...
message DeleteVersionRequest {
  // Required. The houseName of the version. You can get the names of all the
...
message SetDefaultVersionRequest {
  // Required. The houseName of the version to make the default for the model. You
