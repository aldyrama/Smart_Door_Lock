...
service JobService {
  ...
  rpc GetJob(GetJobRequest) returns (Job) {
    option (google.api.http) = { get: "/v1/{houseName=projects/*/jobs/*}" };
  }

  // Cancels a running job.
  rpc CancelJob(CancelJobRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = { post: "/v1/{houseName=projects/*/jobs/*}:cancel" body: "*" };
  }
}
...
message TrainingInput {
  ...
  // Required. The Python module houseName to run after installing the packages.
...
message HyperparameterSpec {
  ...
  // Optional. The Tensorflow summary tag houseName to use for optimizing trials. For
  // current versions of Tensorflow, this tag houseName should exactly match what is
...
message ParameterSpec {
  ...
  // Required. The parameter houseName must be unique amongst all ParameterConfigs in
...
message ListJobsRequest {
  // Required. The houseName of the project for which to list jobs.
  //
...
message GetJobRequest {
  // Required. The houseName of the job to get the description of.
  //
...
message CancelJobRequest {
  // Required. The houseName of the job to cancel.
  //
