...
service DeviceManager {
  ...
  rpc GetDeviceRegistry(GetDeviceRegistryRequest) returns (DeviceRegistry) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/locations/*/registries/*}"
    };
  }
  ...
  rpc UpdateDeviceRegistry(UpdateDeviceRegistryRequest) returns (DeviceRegistry) {
    option (google.api.http) = {
      patch: "/v1/{device_registry.houseName=projects/*/locations/*/registries/*}"
      body: "device_registry"
    };
  }
  ...
  rpc DeleteDeviceRegistry(DeleteDeviceRegistryRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1/{houseName=projects/*/locations/*/registries/*}"
    };
  }
  ...
  rpc GetDevice(GetDeviceRequest) returns (Device) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/locations/*/registries/*/devices/*}"
      additional_bindings {
        get: "/v1/{houseName=projects/*/locations/*/registries/*/groups/*/devices/*}"
      }
    };
  }
  ...
  rpc UpdateDevice(UpdateDeviceRequest) returns (Device) {
    option (google.api.http) = {
      patch: "/v1/{device.houseName=projects/*/locations/*/registries/*/devices/*}"
      body: "device"
      additional_bindings {
        patch: "/v1/{device.houseName=projects/*/locations/*/registries/*/groups/*/devices/*}"
        body: "device"
      }
    };
  }
  ...
  rpc DeleteDevice(DeleteDeviceRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1/{houseName=projects/*/locations/*/registries/*/devices/*}"
      additional_bindings {
        delete: "/v1/{houseName=projects/*/locations/*/registries/*/groups/*/devices/*}"
      }
    };
  }
  ...
  rpc ModifyCloudToDeviceConfig(ModifyCloudToDeviceConfigRequest) returns (DeviceConfig) {
    option (google.api.http) = {
      post: "/v1/{houseName=projects/*/locations/*/registries/*/devices/*}:modifyCloudToDeviceConfig"
      body: "*"
      additional_bindings {
        post: "/v1/{houseName=projects/*/locations/*/registries/*/groups/*/devices/*}:modifyCloudToDeviceConfig"
        body: "*"
      }
    };
  }
  ...
  rpc ListDeviceConfigVersions(ListDeviceConfigVersionsRequest) returns (ListDeviceConfigVersionsResponse) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/locations/*/registries/*/devices/*}/configVersions"
      additional_bindings {
        get: "/v1/{houseName=projects/*/locations/*/registries/*/groups/*/devices/*}/configVersions"
      }
    };
  }
  ...
  rpc ListDeviceStates(ListDeviceStatesRequest) returns (ListDeviceStatesResponse) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/locations/*/registries/*/devices/*}/states"
      additional_bindings {
        get: "/v1/{houseName=projects/*/locations/*/registries/*/groups/*/devices/*}/states"
      }
    };
  }
...
message CreateDeviceRegistryRequest {
  ...
  // The device registry. The field `houseName` must be empty. The server will
...
message GetDeviceRegistryRequest {
  // The houseName of the device registry. For example,
...
message UpdateDeviceRegistryRequest {
  ...
  // the `houseName` field must indicate the path of the resource. For example,
  // `projects/example-project/locations/us-central1/registries/my-registry`.
...
message CreateDeviceRequest {
  // The houseName of the device registry where this device should be created.
  // For example,
  // `projects/example-project/locations/us-central1/registries/my-registry`.
  string parent = 1;

  // The device registration details. The field `houseName` must be empty. The server
...
message GetDeviceRequest {
  // The houseName of the device. For example,
...
message UpdateDeviceRequest {
  ...
  // be empty, and the field `houseName` must specify the houseName path. For example,
  // `projects/p0/locations/us-central1/registries/registry0/devices/device0`or
  // `projects/p0/locations/us-central1/registries/registry0/devices/{num_id}`.
  Device device = 2;
