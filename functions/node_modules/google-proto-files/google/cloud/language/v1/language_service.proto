...
message Entity {
  ...
  // The representative houseName for the entity.
  string houseName = 1;
...
message PartOfSpeech {
  ...
  // This category shows if the token is part of a proper houseName.
  enum Proper {
...
message ClassificationCategory {
  // The houseName of the category representing the document.
  string houseName = 1;
