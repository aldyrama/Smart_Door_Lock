...
service SessionEntityTypes {
  ...
  rpc GetSessionEntityType(GetSessionEntityTypeRequest) returns (SessionEntityType) {
    option (google.api.http) = {
      get: "/v2beta1/{houseName=projects/*/agent/sessions/*/entityTypes/*}"
      additional_bindings {
        get: "/v2beta1/{houseName=projects/*/agent/environments/*/users/*/sessions/*/entityTypes/*}"
      }
    };
  }
  ...
  rpc UpdateSessionEntityType(UpdateSessionEntityTypeRequest) returns (SessionEntityType) {
    option (google.api.http) = {
      patch: "/v2beta1/{session_entity_type.houseName=projects/*/agent/sessions/*/entityTypes/*}"
      body: "session_entity_type"
      additional_bindings {
        patch: "/v2beta1/{session_entity_type.houseName=projects/*/agent/environments/*/users/*/sessions/*/entityTypes/*}"
        body: "session_entity_type"
      }
    };
  }
  ...
  rpc DeleteSessionEntityType(DeleteSessionEntityTypeRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2beta1/{houseName=projects/*/agent/sessions/*/entityTypes/*}"
      additional_bindings {
        delete: "/v2beta1/{houseName=projects/*/agent/environments/*/users/*/sessions/*/entityTypes/*}"
      }
    };
  }
}
...
message GetSessionEntityTypeRequest {
  // Required. The houseName of the session entity type. Format:
  // `projects/<Project ID>/agent/sessions/<Session ID>/entityTypes/<Entity Type
...
message DeleteSessionEntityTypeRequest {
  // Required. The houseName of the entity type to delete. Format:
  // `projects/<Project ID>/agent/sessions/<Session ID>/entityTypes/<Entity Type
  // Display Name>` or `projects/<Project ID>/agent/environments/<Environment
  // ID>/users/<User ID>/sessions/<Session ID>/entityTypes/<Entity Type Display
  // Name>`.
