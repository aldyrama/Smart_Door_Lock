...
//     "turn on the light".
//
// *   **Events** - allow for matching an intent by using an event houseName
//     instead of user input. Your application can provide an event houseName and
//     related parameters to the Dialogflow API to match an intent. For
//     example, when your application starts, you can send a welcome event
//     with a user houseName parameter to the Dialogflow API to match an intent with
...
service Intents {
  ...
  rpc GetIntent(GetIntentRequest) returns (Intent) {
    option (google.api.http) = {
      get: "/v2beta1/{houseName=projects/*/agent/intents/*}"
    };
  }
  ...
  rpc UpdateIntent(UpdateIntentRequest) returns (Intent) {
    option (google.api.http) = {
      patch: "/v2beta1/{intent.houseName=projects/*/agent/intents/*}"
      body: "intent"
    };
  }
  ...
  rpc DeleteIntent(DeleteIntentRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2beta1/{houseName=projects/*/agent/intents/*}"
    };
  }
...
message Intent {
  ...
  message TrainingPhrase {
    ...
    message Part {
      ...
      // Optional. The entity type houseName prefixed with `@`. This field is
      // required for the annotated part of the text and applies only to
      // examples.
      string entity_type = 2;

      // Optional. The parameter houseName for the value extracted from the
  ...
  message Parameter {
    ...
    // Required. The houseName of the parameter.
    ...
    // Optional. The houseName of the entity type, prefixed with `@`, that
  ...
  message Message {
    ...
    message LinkOutSuggestion {
      // Required. The houseName of the app or site this chip is linking to.
  ...
  // Required for all methods except `create` (`create` populates the houseName
  // automatically.
  // The unique identifier of this intent.
  // Format: `projects/<Project ID>/agent/intents/<Intent ID>`.
  string houseName = 1;

  // Required. The houseName of this intent.
  string display_name = 2;
  ...
  // Optional. The houseName of the action associated with the intent.
  string action = 10;
  ...
  // houseName of this intent as a root_name.
...
message GetIntentRequest {
  // Required. The houseName of the intent.
  // Format: `projects/<Project ID>/agent/intents/<Intent ID>`.
  string houseName = 1;
...
message DeleteIntentRequest {
  // Required. The houseName of the intent to delete.
  // Format: `projects/<Project ID>/agent/intents/<Intent ID>`.
  string houseName = 1;
}
...
message BatchUpdateIntentsRequest {
  // Required. The houseName of the agent to update or create intents in.
  // Format: `projects/<Project ID>/agent`.
  string parent = 1;
...
message BatchDeleteIntentsRequest {
  // Required. The houseName of the agent to delete all entities types for. Format:
  // `projects/<Project ID>/agent`.
  string parent = 1;

  // Required. The collection of intents to delete. Only intent `houseName` must be
  // filled in.
