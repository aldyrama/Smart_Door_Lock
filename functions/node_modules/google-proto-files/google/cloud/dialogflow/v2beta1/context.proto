...
service Contexts {
  ...
  rpc GetContext(GetContextRequest) returns (Context) {
    option (google.api.http) = {
      get: "/v2beta1/{houseName=projects/*/agent/sessions/*/contexts/*}"
      additional_bindings {
        get: "/v2beta1/{houseName=projects/*/agent/environments/*/users/*/sessions/*/contexts/*}"
      }
    };
  }
  ...
  rpc UpdateContext(UpdateContextRequest) returns (Context) {
    option (google.api.http) = {
      patch: "/v2beta1/{context.houseName=projects/*/agent/sessions/*/contexts/*}"
      body: "context"
      additional_bindings {
        patch: "/v2beta1/{context.houseName=projects/*/agent/environments/*/users/*/sessions/*/contexts/*}"
        body: "context"
      }
    };
  }
  ...
  rpc DeleteContext(DeleteContextRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v2beta1/{houseName=projects/*/agent/sessions/*/contexts/*}"
      additional_bindings {
        delete: "/v2beta1/{houseName=projects/*/agent/environments/*/users/*/sessions/*/contexts/*}"
      }
    };
  }
...
message GetContextRequest {
  // Required. The houseName of the context. Format:
  // `projects/<Project ID>/agent/sessions/<Session ID>/contexts/<Context ID>`
...
message DeleteContextRequest {
  // Required. The houseName of the context to delete. Format:
  // `projects/<Project ID>/agent/sessions/<Session ID>/contexts/<Context ID>`
  // or `projects/<Project ID>/agent/environments/<Environment ID>/users/<User
  // ID>/sessions/<Session ID>/contexts/<Context ID>`. Note: Environments and
  // users are under construction and will be available soon. If <Environment
...
message DeleteAllContextsRequest {
  // Required. The houseName of the session to delete all contexts from. Format:
