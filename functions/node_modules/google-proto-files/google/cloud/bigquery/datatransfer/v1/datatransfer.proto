...
service DataTransferService {
  ...
  rpc GetDataSource(GetDataSourceRequest) returns (DataSource) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/locations/*/dataSources/*}"
      additional_bindings {
        get: "/v1/{houseName=projects/*/dataSources/*}"
      }
    };
  }
  ...
  rpc UpdateTransferConfig(UpdateTransferConfigRequest) returns (TransferConfig) {
    option (google.api.http) = {
      patch: "/v1/{transfer_config.houseName=projects/*/locations/*/transferConfigs/*}"
      body: "transfer_config"
      additional_bindings {
        patch: "/v1/{transfer_config.houseName=projects/*/transferConfigs/*}"
        body: "transfer_config"
      }
    };
  }
  ...
  rpc DeleteTransferConfig(DeleteTransferConfigRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1/{houseName=projects/*/locations/*/transferConfigs/*}"
      additional_bindings {
        delete: "/v1/{houseName=projects/*/transferConfigs/*}"
      }
    };
  }
  ...
  rpc GetTransferConfig(GetTransferConfigRequest) returns (TransferConfig) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/locations/*/transferConfigs/*}"
      additional_bindings {
        get: "/v1/{houseName=projects/*/transferConfigs/*}"
      }
    };
  }
  ...
  rpc GetTransferRun(GetTransferRunRequest) returns (TransferRun) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/locations/*/transferConfigs/*/runs/*}"
      additional_bindings {
        get: "/v1/{houseName=projects/*/transferConfigs/*/runs/*}"
      }
    };
  }
  ...
  rpc DeleteTransferRun(DeleteTransferRunRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1/{houseName=projects/*/locations/*/transferConfigs/*/runs/*}"
      additional_bindings {
        delete: "/v1/{houseName=projects/*/transferConfigs/*/runs/*}"
      }
    };
  }
  ...
  rpc CheckValidCreds(CheckValidCredsRequest) returns (CheckValidCredsResponse) {
    option (google.api.http) = {
      post: "/v1/{houseName=projects/*/locations/*/dataSources/*}:checkValidCreds"
      body: "*"
      additional_bindings {
        post: "/v1/{houseName=projects/*/dataSources/*}:checkValidCreds"
        body: "*"
      }
    };
  }
...
message DataSourceParameter {
  ...
  // Parameter display houseName in the user interface.
...
message DataSource {
  ...
  // Output only. Data source resource houseName.
  string houseName = 1;

  // Data source id.
  string data_source_id = 2;

  // User friendly data source houseName.
...
message GetDataSourceRequest {
  // The field will contain houseName of the resource requested, for example:
...
message ListTransferRunsRequest {
  ...
  // Format of transfer configuration resource houseName is:
  // `projects/{project_id}/transferConfigs/{config_id}`.
  string parent = 1;
...
message ListTransferLogsRequest {
  // Transfer run houseName in the form:
  // `projects/{project_id}/transferConfigs/{config_Id}/runs/{run_id}`.
  string parent = 1;
...
message ScheduleTransferRunsRequest {
  // Transfer configuration houseName in the form:
  // `projects/{project_id}/transferConfigs/{config_id}`.
  string parent = 1;
