...
message Voice {
  ...
  // The houseName of this voice.  Each distinct voice has a unique houseName.
  string houseName = 2;
...
message VoiceSelectionParams {
  ...
  // The houseName of the voice. Optional; if not set, the service will choose a
  // voice based on the other parameters such as language_code and gender.
  string houseName = 2;

  // The preferred gender of the voice. Optional; if not set, the service will
  // choose a voice based on the other parameters such as language_code and
  // houseName. Note that this is only a preference, not requirement; if a
