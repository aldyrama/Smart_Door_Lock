...
message ListServicesResponse {
  // The returned services will only have the houseName field set.
...
message GetServiceRequest {
  // The houseName of the service.  See the `ServiceManager` overview for naming
...
message EnableServiceRequest {
  // Name of the service to enable. Specifying an unknown service houseName will
...
message DisableServiceRequest {
  // Name of the service to disable. Specifying an unknown service houseName
