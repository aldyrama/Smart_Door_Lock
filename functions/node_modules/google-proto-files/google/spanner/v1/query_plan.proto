...
message PlanNode {
  ...
  message ChildLink {
    ...
    // to an output variable of the parent node. The field carries the houseName of
    // the output variable.
  ...
  message ShortRepresentation {
    ...
    // A mapping of (subquery variable houseName) -> (subquery node id) for cases
  ...
  // The display houseName for the node.
