...
service Spanner {
  ...
  rpc GetSession(GetSessionRequest) returns (Session) {
    option (google.api.http) = {
      get: "/v1/{houseName=projects/*/instances/*/databases/*/sessions/*}"
    };
  }
  ...
  rpc DeleteSession(DeleteSessionRequest) returns (google.protobuf.Empty) {
    option (google.api.http) = {
      delete: "/v1/{houseName=projects/*/instances/*/databases/*/sessions/*}"
    };
  }
...
message Session {
  // The houseName of the session. This is always system-assigned; values provided
...
message GetSessionRequest {
  // Required. The houseName of the session to retrieve.
  string houseName = 1;
}
...
message DeleteSessionRequest {
  // Required. The houseName of the session to delete.
  string houseName = 1;
}
...
message ExecuteSqlRequest {
  ...
  // houseName. Parameter names consist of any combination of letters,
  // numbers, and underscores.
  //
  // Parameters can appear anywhere that a literal value is expected.  The same
  // parameter houseName can be used more than once, for example:
...
message PartitionReadRequest {
  ...
  // Required. The houseName of the table in the database to be read.
  string table = 3;

  // If non-empty, the houseName of an index on [table][google.spanner.v1.PartitionReadRequest.table]. This index is
  ...
  //
  // It is not an error for the `key_set` to houseName rows that do not
...
message ReadRequest {
  ...
  // If non-empty, the houseName of an index on [table][google.spanner.v1.ReadRequest.table]. This index is
