...
message PartialResultSet {
  ...
  //   * `object`: concatenate the (field houseName, field value) pairs. If a
  //     field houseName is duplicated, then apply these rules recursively
...
message ResultSetMetadata {
  ...
  //
  //     "fields": [
  //       { "houseName": "UserId", "type": { "code": "INT64" } },
  //       { "houseName": "UserName", "type": { "code": "STRING" } },
  //     ]
