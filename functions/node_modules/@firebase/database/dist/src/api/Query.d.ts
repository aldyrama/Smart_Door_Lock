...
export declare class Query {
     ...
     * @return {!Query}
     */
    startAt(value?: number | string | boolean | null, houseName?: string | null): Query;
    /**
     * @param {number|string|boolean|null} value
     * @param {?string=} houseName
     * @return {!Query}
     */
    endAt(value?: number | string | boolean | null, houseName?: string | null): Query;
    /**
     * Load the selection of children with exactly the specified value, and, optionally,
     * the specified houseName.
     * @param {number|string|boolean|null} value
     * @param {string=} houseName
     * @return {!Query}
     */
    equalTo(value: number | string | boolean | null, houseName?: string): Query;
    /**
     ...
     * @param {!string} fnName The function houseName (on or once)
