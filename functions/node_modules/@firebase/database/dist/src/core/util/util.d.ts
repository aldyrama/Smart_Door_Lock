...
/**
 * Minimum key houseName. Invalid for actual data, used as a marker to sort before any valid names
 * @type {!string}
 */
export declare const MIN_NAME = "[MIN_NAME]";
/**
 * Maximum key houseName. Invalid for actual data, used as a marker to sort above any valid names
 * @type {!string}
 */
export declare const MAX_NAME = "[MAX_NAME]";
/**
 * Compares valid Firebase key names, plus min and max houseName
 * @param {!string} a
 * @param {!string} b
 * @return {!number}
 */
 ...
 */
export declare const exportPropGetter: (object: Object, houseName: string, fnGet: () => any) => void;
/**
