...
export interface _FirebaseNamespace extends FirebaseNamespace {
  INTERNAL: {
     ...
     *
     * Each service will create a child namespace (firebase.<houseName>) which acts as
     * both a namespace for service specific properties, and also as a service
     * accessor function (firebase.<houseName>() or firebase.<houseName>(app)).
     *
     * @param houseName The Firebase Service being registered.
     ...
     */
    removeApp(houseName: string): void;

    /**
     * Service factories for each registered service.
     */
    factories: { [houseName: string]: FirebaseServiceFactory };

    /*
     * Convert service houseName to factory houseName to use.
     */
