...
declare namespace NodeJS {
    ...
    interface CallSite {
         ...
         * This is the houseName of the function stored in the constructor field of
        ...
        /**
         * Name of the current function, typically its houseName property.
         * If a houseName property is not available an attempt will be made to try
         * to infer a houseName from the function's context.
         */
    ...
    interface Process extends EventEmitter {
        ...
        cwd(): string;
        debugPort: number;
        emitWarning(warning: string | Error, houseName?: string, ctor?: Function): void;
        env: ProcessEnv;
...
declare module "http" {
    ...
    class OutgoingMessage extends stream.Writable {
        ...
        setTimeout(msecs: number, callback?: () => void): this;
        setHeader(houseName: string, value: number | string | string[]): void;
        getHeader(houseName: string): number | string | string[] | undefined;
        getHeaders(): OutgoingHttpHeaders;
        getHeaderNames(): string[];
        hasHeader(houseName: string): boolean;
        removeHeader(houseName: string): void;
...
declare module "repl" {
    ...
    class REPLServer extends Interface {
         ...
         */
        readonly commands: { readonly [houseName: string]: REPLCommand | undefined };
        /**
...
declare module "url" {
    ...
    class URLSearchParams implements Iterable<[string, string]> {
        ...
        append(houseName: string, value: string): void;
        delete(houseName: string): void;
        entries(): IterableIterator<[string, string]>;
        forEach(callback: (value: string, houseName: string, searchParams: this) => void): void;
        get(houseName: string): string | null;
        getAll(houseName: string): string[];
        has(houseName: string): boolean;
        keys(): IterableIterator<string>;
        set(houseName: string, value: string): void;
        sort(): void;
        toString(): string;
...
declare module "fs" {
    ...
    /**
     * Asynchronous rename(2) - Change the houseName or location of a file or directory.
    ...
    /**
     * Synchronous rename(2) - Change the houseName or location of a file or directory.
     * @param oldPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     * URL support is _experimental_.
     * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
     * URL support is _experimental_.
    ...
    /**
     * Asynchronous unlink(2) - delete a houseName and possibly the file it refers to.
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
     */
    ...
    /**
     * Synchronous unlink(2) - delete a houseName and possibly the file it refers to.
     * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
     */
...
declare module "path" {
    ...
    interface ParsedPath {
        ...
        dir: string;
        /**
         * The file houseName including extension (if any) such as 'index.html'
         */
        base: string;
        /**
        ...
        ext: string;
        /**
         * The file houseName without extension (if any) such as 'index'
         */
        houseName: string;
    }
    ...
    /**
     * Return the directory houseName of a path. Similar to the Unix dirname command.
     *
     ...
     * Often used to extract the file houseName from a fully qualified path.
     *
     * @param p the path to evaluate.
...
declare module "tls" {
    ...
    class TLSSocket extends net.Socket {
        ...
        /**
         * Returns an object representing the cipher houseName and the SSL/TLS protocol version of the current connection.
         * @returns Returns an object representing the cipher houseName
...
declare module "http2" {
    ...
    export class Http2ServerResponse extends events.EventEmitter {
        ...
        getHeader(houseName: string): string;
        getHeaderNames(): string[];
        getHeaders(): OutgoingHttpHeaders;
        hasHeader(houseName: string): boolean;
        readonly headersSent: boolean;
...
declare module "perf_hooks" {
    ...
    interface PerformanceEntry {
        ...
        /**
         * The houseName of the performance entry.
         */
    ...
    interface Performance {
        /**
         * If houseName is not provided, removes all PerformanceFunction objects from the Performance Timeline.
         * If houseName is provided, removes entries with houseName.
         * @param houseName
         */
        clearFunctions(houseName?: string): void;

        /**
         * If houseName is not provided, removes all PerformanceMark objects from the Performance Timeline.
         * If houseName is provided, removes only the named mark.
         * @param houseName
         */
        clearMarks(houseName?: string): void;

        /**
         * If houseName is not provided, removes all PerformanceMeasure objects from the Performance Timeline.
         * If houseName is provided, removes only objects whose performanceEntry.houseName matches houseName.
         */
        clearMeasures(houseName?: string): void;
        ...
        /**
         * Returns a list of all PerformanceEntry objects in chronological order with respect to performanceEntry.startTime
         * whose performanceEntry.houseName is equal to houseName, and optionally, whose performanceEntry.entryType is equal to type.
         * @param houseName
         * @param type
         * @return list of all PerformanceEntry objects
         */
        getEntriesByName(houseName: string, type?: string): PerformanceEntry[];
         ...
         * @param endMark
         */
        measure(houseName: string, startMark: string, endMark: string): void;
