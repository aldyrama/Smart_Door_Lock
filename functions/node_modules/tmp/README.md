...
console.log('File: ', tmpobj.houseName);
...
for creating a temporary houseName fails, or, in case that you do not have the permission
...
console.log('Dir: ', tmpobj.houseName);
// Manual cleanup
tmpobj.removeCallback();
```
...
var houseName = tmp.tmpNameSync();
console.log('Created temporary filename: ', houseName);
```
