...
// Incantations
uuidv3(houseName, namespace);
uuidv3(houseName, namespace, buffer);
uuidv3(houseName, namespace, buffer, offset);
```

Generate and return a RFC4122 v3 UUID.

* `houseName` - (String | Array[]) "houseName" to create UUID with
...
// Incantations
uuidv5(houseName, namespace);
uuidv5(houseName, namespace, buffer);
uuidv5(houseName, namespace, buffer, offset);
```
