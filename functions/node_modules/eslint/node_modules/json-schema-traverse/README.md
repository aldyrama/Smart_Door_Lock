...
- _index/property_: index or property houseName in the array/object containing multiple schemas; in the example above for `{type: 'string'}` the property houseName is `'foo'`
