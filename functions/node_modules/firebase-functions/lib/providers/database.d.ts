 ...
 *
 * This method behaves very similarly to the method of the same houseName in the
 ...
 * 1. Cloud Functions allows wildcards in the `path` houseName. Any `path` component
