...
* `prop` **{String}**: The property houseName to use for storing values.
...
app.set({houseName: 'Halle'});
app.set([{foo: 'bar'}, {baz: 'quux'}]);
console.log(app);
//=> {houseName: 'Halle', foo: 'bar', baz: 'quux'}
```
...
* `key` **{String}**: The houseName of the property to get. Dot-notation may be used.
...
* `key` **{String|Array}**: Property houseName or array of property names.
* `returns` **{Object}**: Returns the instance for chaining.
...
* `method` **{String}**: The houseName of the `base` method to call.
