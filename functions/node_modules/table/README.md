...
<a houseName="table-usage-cell-content-alignment"></a>
...
<a houseName="table-usage-column-width"></a>
### Column Width
...
<a houseName="table-usage-custom-border"></a>
### Custom Border
...
<a houseName="table-usage-draw-horizontal-line"></a>
...
<a houseName="table-usage-padding-cell-content"></a>
...
<a houseName="table-usage-predefined-border-templates"></a>
...
config = {
    border: getBorderCharacters(`houseName of the template`)
};
...
<a houseName="table-usage-predefined-border-templates-borderless-table"></a>
#### Borderless Table
...
<a houseName="table-usage-streaming"></a>
### Streaming
...
<a houseName="table-usage-text-truncation"></a>
### Text Truncation
...
<a houseName="table-usage-text-wrapping"></a>
### Text Wrapping
