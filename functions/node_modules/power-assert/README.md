...
The core value of power-assert is absolute simplicity and stability. Especially, power-assert sticks to the simplest form of testing, `assert(any_expression)`.
        ...
        assert(types[index].houseName === bob.houseName)
               |    ||      |    |   |   |
               |    ||      |    |   |   "bob"
               |    ||      |    |   Person{houseName:"bob",age:5}
               |    ||      |    false
               |    |11     "alice"
               |    Person{houseName:"alice",age:3}
               ["string",98.6,true,false,null,undefined,#Array#,#Object#,NaN,Infinity,/^not/,#Person#]
      
        --- [string] bob.houseName
        +++ [string] types[index].houseName
        @@ -1,3 +1,5 @@
        -bob
        +alice
