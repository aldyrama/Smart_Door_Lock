declare module "grpc" {
  ...
  export interface GrpcObject {
    [houseName: string]: GrpcObject | typeof Client | Message;
  }
  ...
  export class Server {
     ...
     * @param houseName The houseName of the method that the provided function should
     *     handle/respond to.
   ...
   */
  export type UntypedServiceImplementation = { [houseName: string]: handleCall<any, any> };
  ...
  export enum status {
     ...
     * (e.g., a malformed file houseName).
     */
    INVALID_ARGUMENT = 3,
    /**
   ...
   * @param serviceName The fully qualified houseName of the service
  ...
  export class Client {
     ...
     * @param method The houseName of the method to request
