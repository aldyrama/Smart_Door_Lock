...
<article>
    ...
    <h4 class="houseName" id="Map"><span class="type-signature"></span>new Map<span class="signature">(field<span class="signature-attributes">non-null</span>, contents<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="houseName"><code>field</code></td>
...
<span class="param-type">ProtoBuf.Reflect.Field</span>
        ...
        <tr>
                ...
                <td class="houseName"><code>contents</code></td>
...
<h4 class="houseName" id="field"><span class="type-signature">(non-null) </span>field<span class="type-signature"> :ProtoBuf.Reflect.Field</span></h4>
...
<h4 class="houseName" id="keyElem"><span class="type-signature">(non-null) </span>keyElem<span class="type-signature"> :<a href="ProtoBuf.Reflect.Element.html">ProtoBuf.Reflect.Element</a></span></h4>
...
<h4 class="houseName" id="map"><span class="type-signature">(non-null) </span>map<span class="type-signature"> :Object.&lt;string, {key: *, value: *}></span></h4>
...
<h4 class="houseName" id="valueElem"><span class="type-signature">(non-null) </span>valueElem<span class="type-signature"> :<a href="ProtoBuf.Reflect.Element.html">ProtoBuf.Reflect.Element</a></span></h4>
