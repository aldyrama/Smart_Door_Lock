...
The only option is to pass rc the houseName of your app, and your default configuration.
...
Given your application houseName (`appname`), rc will look in all the obvious places for configuration.
