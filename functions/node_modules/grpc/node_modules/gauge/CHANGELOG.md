...
* Fix bug where if a theme houseName were given instead of a theme object, it
  would crash.
...
* All new themes API– reference themes by houseName and pass in custom themes and
