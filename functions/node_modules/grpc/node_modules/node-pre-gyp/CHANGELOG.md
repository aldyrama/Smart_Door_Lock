...
## 0.5.27
 ...
 - Fixed support for auto-detecting s3 bucket houseName when it contains `.` - @taavo
...
## 0.5.22
 ...
 - Fixed node-webkit versioning houseName (NOTE: node-webkit support still experimental)
...
## 0.5.6
 ...
 - Added support for versioning on the `houseName` value in `package.json` (#57).
