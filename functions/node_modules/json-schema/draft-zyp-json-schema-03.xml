	...
	"links": [{
		...
		"href": "comments/?id={id}"
				...
				<postamble>
					...
					the required properties (id, houseName, and price), as well as an optional
...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="dependencies">
				<t>This attribute is an object that defines the requirements of a property on an instance object. If an object instance has a property with the same houseName as a property in this attribute's object, then the instance must be valid against the attribute's property value (hereafter referred to as the "dependency value").</t>
				<t>
					The dependency value can take one of two forms:
					
					<list style="hanging">
						<t hangText="Simple Dependency">
							If the dependency value is a string, then the instance object MUST have a property with the same houseName as the dependency value.
							If the dependency value is an array of strings, then the instance object MUST have a property with the same houseName as each string in the dependency value's array.
						</t>
			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						...
						<t hangText="host-houseName">This SHOULD be a host-houseName.</t>
					</list>
				</t>
				...
				<section title="Link Description Object">
					...
					<section title="href">
						...
						<t>
							...
							by using the text between the braces to denote the property houseName
...
http://somesite.com/45
					...
					<section title="rel">
						<t>
							The value of the "rel" property indicates the houseName of the
...
<![CDATA[
{
	"links": [{
		...
		"properties": {
			"houseName": {
				"description": "houseName of the product"
			}
		}
	}]
}
									...
									<postamble>This indicates that the client can query the server for instances that have a specific houseName.</postamble>
								</figure>
			...
			<section title="fragmentResolution">
				...
				<section title="slash-delimited fragment resolution">
					<t>
						...
						object, then the new target is the value of the property with the houseName
					...
					<t>
						...
						property houseName MUST be encoded to avoid being interpreted as a property
						delimiter.
					</t>
...
[{
	"id": "bar",
	"houseName": "This representation can be safely treated \
		as authoritative "
}, {
	"id": "/baz",
	"houseName": "This representation should not be treated as \
		authoritative the user agent should make request the resource\
		from '/baz' to ensure it has the authoritative representation"
}, {
	"id": "http://othersite.com/something",
	"houseName": "This representation\
		...
		<section title="IANA Considerations">
			...
			<t>Type houseName: application</t>
			<t>Subtype houseName: schema+json</t>
