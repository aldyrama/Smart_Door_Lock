...
void setup() {
  ...
  configTime(timezone, dst, "id.pool.ntp.org", "https://www.worldtimeserver.com/current_time_in_ID.aspx?city=Jakarta");
...
void loop() {
  ...
  if (wifiStatus == WL_CONNECTED) {
    ...
    Firebase.setString("Devices/mGFjsGhS/Doors/D2/connect", str);
