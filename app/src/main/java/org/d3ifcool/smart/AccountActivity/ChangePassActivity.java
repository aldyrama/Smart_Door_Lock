...
public class ChangePassActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText repass, newpass, email;
            ...
            public void onClick(View v) {
                ...
                if (user != null && !newpass.getText().toString().trim().equals("")) {
                    if (newpass.getText().toString().trim().length() < 6) {
                        ...
                        loading.hide();
                        Toast.makeText(ChangePassActivity.this, "Your password do not match with your confirm password",
    ...
    // Check editText isEmpety
    private TextWatcher nextRegistWatcher = new TextWatcher() {
        @Override
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            String repassword = newpass.getText().toString().trim();

            submit.setEnabled(!password.isEmpty() && !repassword.isEmpty());
        }
